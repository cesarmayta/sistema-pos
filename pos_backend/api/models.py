...
class Mesa(models.Model):
    ...
    mesa_nro = models.CharField(max_length=2,verbose_name='Nro Mesa')
...
class Plato(models.Model):
    ...
    categoria_id = models.ForeignKey(Categoria,related_name='Platos',db_column='categoria_id',
                                     on_delete=models.RESTRICT,verbose_name='Categoria')
...
class Pedido(models.Model):
    ...
    mesa_id = models.ForeignKey(Mesa,to_field='mesa_id',db_column='mesa_id',
                                on_delete=models.RESTRICT)
    usu_id = models.ForeignKey(User,to_field='id',related_name='Pedidos',
                               on_delete=models.RESTRICT,db_column='usu_id')
